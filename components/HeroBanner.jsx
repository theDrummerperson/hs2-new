...
export default function HeroBanner() {
  ...
  return (
    // Changed background from bg-[#F9F6F1] to bg-[#8A0303]
    <section className="relative min-h-[80vh] bg-[#8A0303] overflow-hidden">
      ...
      <div className="absolute inset-0 z-0 overflow-hidden">
        ...
        >
          <Image
            ...
            priority
          />
          {/* Changed gradient from-[#F9F6F1] to from-[#8A0303] to match the new background */}
          <div className="absolute inset-0 bg-gradient-to-l from-[#8A0303] to-transparent" />
      ...
      <div className="relative z-10 flex flex-col justify-center my-8 md:my-0 md:h-[80vh] px-4 md:px-0 max-w-md md:ml-16">
        <div className="p-8 backdrop-blur-md bg-[#F9F6F1]/90 shadow-2xl rounded-2xl">
